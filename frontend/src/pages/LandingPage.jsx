...
const LandingPage = () => {
  ...
  const handleCTA = () => {
    // Navigate to dashboard or authentication page
  }
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="w-full md:w-1/2">
              ...
              <h1 className="text-4xl md:text-5xl text-black font-semibold leading-tight mb-6">
            ...
            {/* Right Content */}
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 md:mr-8 mb-6">
      ...
      <div className="w-full min-h-full relative z-10">
        <div>
          <section className="flex items-center justify-center -mt-86">
            <img src={img} alt="Hero Image" className="w-[80vw] rounded-lg " />
          </section>
        </div>
